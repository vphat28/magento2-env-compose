define(
    ...
    function (Component, $, priceUtils, urlBuilder, loader, quote) {
        ...
        return Component.extend({
            defaults: {
                template: 'Stripeofficial_BANCONTACT/payment/form',
                code: 'stripebancontact',
                active: false
            },
            ...
            isActive: function () {
                ...
                if (active == false) {
                    jQuery("#stripe_bancontact").hide();
                } else {
                    jQuery("#stripe_bancontact").show();
                }
            ...
            imagePath: function () {
                ...
                return baseUrl + 'Stripeofficial_Core/stripe/bancontact.png';
            },
            ...
            stripePlaceOrder: function () {
                ...
                if (!this.isValidate()) {
                    ...
                    var requestObject = {
                        ...
                        redirect: {
                            return_url: urlBuilder.build('stripe/bancontact/returnurl')
                        }
                    };
