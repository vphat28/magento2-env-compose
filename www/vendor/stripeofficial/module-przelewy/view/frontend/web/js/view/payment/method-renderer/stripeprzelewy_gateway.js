define(
    ...
    function (Component, $, priceUtils, urlBuilder, loader, quote) {
        ...
        return Component.extend({
            defaults: {
                template: 'Stripeofficial_Przelewy/payment/form',
                code: 'stripeprzelewy',
                active: false
            },
            ...
            isActive: function () {
                ...
                if (active == false) {
                    jQuery("#stripe_przelewy").hide();
                } else {
                    jQuery("#stripe_przelewy").show();
                }
            ...
            imagePath: function () {
                ...
                return baseUrl + 'Stripeofficial_Core/stripe/p24.png';
            },
            ...
            stripePlaceOrder: function () {
                ...
                if (!this.isValidate()) {
                    ...
                    var requestObject = {
                        ...
                        redirect: {
                            return_url: urlBuilder.build('stripe/przelewy/returnurl')
                        }
                    };
