...
namespace Stripeofficial\SOFORT\Controller\SOFORT;
    ...
    public function execute()
    {
        if (empty($this->http->getParam('source'))) {
            ...
            if ($sourceData['status'] == 'failed') {
                ...
                $this->messageManager->addSuccessMessage(__('Thank you for your payment. The SOFORT process can takes up to 14 days.'));
            }
        }
