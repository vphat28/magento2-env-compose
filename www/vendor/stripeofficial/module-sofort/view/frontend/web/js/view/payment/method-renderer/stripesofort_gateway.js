define(
    ...
    function (Component, $, priceUtils, urlBuilder, loader, quote) {
        ...
        return Component.extend({
            defaults: {
                template: 'Stripeofficial_SOFORT/payment/form',
                code: 'stripesofort',
                active: false
            },
            ...
            isActive: function () {
                ...
                if (active == false) {
                    jQuery("#stripe_sofort").hide();
                } else {
                    jQuery("#stripe_sofort").show();
                }
            ...
            imagePath: function () {
                ...
                return baseUrl + 'Stripeofficial_Core/stripe/sofort.png';
            },
            ...
            stripePlaceOrder: function () {
                ...
                if (!this.isValidate()) {
                    ...
                    const customerEmail = window.StripeCustomerData.customer_email;
                    const customerName = window.StripeCustomerData.fullname;
                    let amount = quote.getTotals()()['base_grand_total'];
                    ...
                    var requestObject = {
                        ...
                        redirect: {
                            return_url: urlBuilder.build('stripe/sofort/returnurl')
                        },
                        sofort: {
                            country: window.StripeCustomerData.country
                        }
