...
namespace Stripeofficial\SOFORT\Observer;
...
use Stripeofficial\SOFORT\Model\Ui\ConfigProvider;
...
class DataAssignAfterSuccessObserver implements ObserverInterface
{
    ...
    public function execute(Observer $observer)
    {
        ...
        if ($order->getData('stripe_source_id')) {
            ...
            $message = 'Authorized amount of %1. SOFORT process can takes up to 14 days. Please hold the shipment until order status is processing';
