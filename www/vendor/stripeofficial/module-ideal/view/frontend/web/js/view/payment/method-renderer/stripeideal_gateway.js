define(
    ...
    function (Component, $, priceUtils, urlBuilder, loader, quote) {
        ...
        return Component.extend({
            defaults: {
                template: 'Stripeofficial_IDeal/payment/form',
                code: 'stripeideal',
                active: false
            },
            ...
            isActive: function () {
                ...
                if (active == false) {
                    jQuery("#stripe_ideal").hide();
                } else {
                    jQuery("#stripe_ideal").show();
                }
            ...
            imagePath: function () {
                ...
                return baseUrl + 'Stripeofficial_Core/stripe/ideal.png';
            },
            ...
            stripePlaceOrder: function () {
                ...
                if (!this.isValidate()) {
                    ...
                    var requestObject = {
                        ...
                        redirect: {
                            return_url: urlBuilder.build('stripe/ideal/returnurl')
                        }
                    };
